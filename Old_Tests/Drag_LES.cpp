...
void NewUserOutput(SPH::Particle * Particles, double & Prop1, double & Prop2,  double & Prop3)
{
	...
	Prop2 = Particles->ShearRate;
	Prop3 = Particles->SBar;
}
...
//	dom.BC.MassConservation = true;
	...
	dom.AddBoxLength(1 ,Vec3_t ( -16.0*Rc , -8.0*Rc , 0.0 ), 32.0*Rc , 16.0*Rc  ,  0 , dx/2.0 ,rho, h, 1 , 0 , false, false );
	...
	dom.OutputName[1]	= "ShearRate";
	dom.OutputName[2]	= "SBar";
        dom.UserOutput		= & NewUserOutput;

	dom.Solve(/*tf*/20000.0,/*dt*/T,/*dtOut*/(200.0*T),"test06",500);
	return 0;
}
MECHSYS_CATCH
